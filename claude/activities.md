...
- **A set-piece restart game needs near-full teams.** A five-man lineout plus a hooker and a 9 is seven players, so a small-sided team is all set-piece and no backline — nobody to attack with off the throw, and no line to speed up in defence. Where a game restarts from a lineout (or a scrum), run **one game at as close to 15 a side as the numbers allow**, even when the numbers would comfortably make two. **Shorten the lineout before you shorten the team.**

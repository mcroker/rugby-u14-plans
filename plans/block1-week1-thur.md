...
| +47, 36 min | Back into the game | Both sides of the lineout live, defensive conditions layered on, and the **Coach's Bag** scanning condition running throughout |
...
*Only one stoppage for coaching all session. **Lineout defence is never taught standing still** — it is coached inside the game, in the pause every lineout gives you.*
...
**Setup:** same game, same channel. Thirty-six minutes, so plan on two clear halves with a short reset between them. **Coaches take their bags and spread out around the pitch** before this block starts — not clustered together.
...
- **Only one stoppage all session** — the lineout positioning recap and Attack off lineout. Everything else is coached while the game is running.

...
| Setup | One bag per coach, coaches spread around the pitch — not clustered, or there's only one place to look. **The club's score-card numbers work as the items** — big, high-contrast, and unarguable to call, which suits a floodlit evening.  Show an item roughly every 30–45 seconds and vary who shows it. |
